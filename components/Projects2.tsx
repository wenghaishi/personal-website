  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <a
            href="https://catch-app.onrender.com"
            target="_blank"
            rel="noreferrer"
          >
            <motion.img
        ...
        >
          <a
            href="https://expense-tracker-lemon.vercel.app/"
            target="_blank"
            rel="noreferrer"
          >
            <motion.img
              ...
              src="default.png"
              alt=""
              className="mb-20 md:mb-0 expense brightness-110 flex-shrink-0 w-56 h-56 rounded-full object-cover
                  md:rounded-lg md:w-80 md:h-80 xl:w-[700px] xl:h-[350px]"
            />
          </a>
          <div className="h-1/4 w-full ">
            ...
            <p className="text-sm md:text-lg text-center md:text-left ">
              An expense tracker app that allows users to add their daily
              expenses. Has analytics, chart and filter features. Built with the
              ReactJS library and vanilla CSS.
            </p>
          </div>
        </div>
      </div>
